Shader "IOX/MaskedSuperPlastic-dissolve" 
{
	Properties
	{
		...
		_MaxPower("MaxPower", Float) = 256
		_MinPower("MinPower", Float) = 16
	...
	SubShader
	{
		...
		Pass
		{
			...
			FragmentOutput frag(v2f i)
			{
				...
				half3 color = lerp(half3(1, 1, 1), _Color * i.color, ctex.r) * ctex.g;
				...
				output.gBuffer1 = float4(0, 0, 0, (ctex.b * _MaxPower + _MinPower) / 256);
