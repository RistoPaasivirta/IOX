...
public class Triangle
{
    ...
    public BooleanBox SelectBox
    {
        get
        {
            ...
            //get bounds
            Vec2I l0min = Vec2I.SelectMin(l0[0], l0[l0.Length - 1]);
            Vec2I l0max = Vec2I.SelectMax(l0[0], l0[l0.Length - 1]);
            Vec2I l1min = Vec2I.SelectMin(l1[0], l1[l1.Length - 1]);
            Vec2I l1max = Vec2I.SelectMax(l1[0], l1[l1.Length - 1]);
            Vec2I l2min = Vec2I.SelectMin(l2[0], l2[l2.Length - 1]);
            Vec2I l2max = Vec2I.SelectMax(l2[0], l2[l2.Length - 1]);
